    ...
    <div className="min-h-96   px-4 ">
      ...
      <iframe
        ...
        style={{
          ...
          height: "100%",
          border: "none",
          pointerEvents: "auto", // Enable scroll and zoom functionality
        }}
        title="PDF Viewer"
      />
      {/* Overlay to block all interactions except scroll and zoom */}
      <div
        style={{
          position: "absolute",
          top: 0,
          ...
          pointerEvents: "none", // Block interactions (like clicking buttons)
        }}
      />
    </div>
                </>
