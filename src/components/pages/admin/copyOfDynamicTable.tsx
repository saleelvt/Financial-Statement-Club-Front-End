...
//   date2: number | null;
// }
// interface PropertytowRow {
//   FirstPropertySubName: string;
//   notes: string;
//   date1: number | null;
//   date2: number | null;
// }
...
//               },
//             ],
//            FirstTotal:  [{ FirstPropertySubName: "First Total", notes: "", date1: null, date2: null }],
//             subPropertieSum: [
//               { SubpropertyName: "", notes: "", date1: null, date2: null },
//               { SubpropertyName: "", notes: "", date1: null, date2: null },
//               { SubpropertyName: "", notes: "", date1: null, date2: null },       
...
//                         {subSection.FirstTotal.map((property, propIndex) => (
//                           <tr
//                             key={`prop-${mainIndex}-${subIndex}-${propIndex}`}
//                           >
//                             <td className="border h-7">
//                               <input
//                                 type="text"
//                                 value={property.FirstPropertySubName}
//                                 onChange={(e) =>
//                                   handlePropertyChange(
//                                     mainIndex,
//                                     subIndex,
...
//                                   )
//                                 }
//                                 className="px-4  font-semibold  text-sm w-[550px] border-l  border-r border-gray-200"
//                                 placeholder="properties"
//                               />
//                             </td>
//                             <td className="border border-gray-300">
