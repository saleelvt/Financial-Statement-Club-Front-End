                ...
                {table.sectionOne.sectionOneTotalLabel &&
                  table.sectionOne.sectionOneTotalLabel.trim() !== "" && (
                    <tr className="bg-gray-200 px-1   font-semibold">
                      ...
                      <td className="border  text-center  border-gray-300"> {table.sectionOne.sectionOsectionOneTotalNoteneTotalLabel}</td>
...
<br />
                ...
                {table.Table2.sectionAttributeTwoTable2.sectionFourAttribute2Table2 && table.Table2.sectionAttributeTwoTable2.sectionFourAttribute2Table2.trim() !==
                    "" && (
                    <tr className="bg-gray-200 font-semibold">
                      <td className="p-1">
