...
const ProfitLossUpdateFormAr: React.FC<TableFormArProps> = React.memo(
  ({ TableDataAr }) => {
...
useEffect(() => {
  console.log("Loading cashflow data for initial setup: ", TableDataAr);
  ...
  if (TableDataAr && Object.keys(TableDataAr).length > 0) {
    try {
      ...
      if (TableDataAr.sectionTwo) {
        const sectionTwo = TableDataAr.sectionTwo;
        
        setSectionTwoLabelsEn(sectionTwo.sectionTwoLabelsEn || Array(12).fill(""));
      ...
      if (TableDataAr.sectionThree) {
        const sectionThree = TableDataAr.sectionThree;
        
        setSectionThreeLabelsEn(sectionThree.sectionThreeLabelsEn || Array(7).fill(""));
      ...
      if (TableDataAr.sectionFour) {
        const sectionFour = TableDataAr.sectionFour;
        
        setSectionFourLabelsEn(sectionFour.sectionFourLabelsEn || Array(5).fill(""));
      ...
      // SECTION ATTRIBUTE TWO - Complete mapping
      ...
      // SECTION OTHER COMPREHENSIVE INCOME - Complete mapping
      if (TableDataAr.sectionOtherComprehensiveIncome) {
        ...
        setSectionFourOtherComprehensiveIncomeSubheadingItemsDate2En(sectionOCI.sectionFourOtherComprehensiveIncomeSubheadingItemsDate2En || Array(2).fill(""));
      }
      
      // TABLE 2 DATA MAPPING
      if (TableDataAr.Table2) {
        const table2 = TableDataAr.Table2;
        
        // Set Table 2 dates
        if (table2.dateTwo1Ar) {
          setDateTwo1Ar(new Date(table2.dateTwo1Ar));
        }
        if (table2.dateTwo2Ar) {
          setDateTwo2Ar(new Date(table2.dateTwo2Ar));
        }
        ...
        // Section Other Comprehensive Income Table 2
        if (table2.sectionOtherComprehensiveIncomeTable2) {
          ...
          setSectionFourOtherComprehensiveIncomeSubheadingItemsDate2EnTable2(sectionOCIT2.sectionFourOtherComprehensiveIncomeSubheadingItemsDate2EnTable2 || Array(2).fill(""));
        }
      }
      ...
      console.error("❌ Error loading cashflow data into state:", error);
    }
  } else {
    console.log("⚠️ TableDataAr is empty, undefined, or has no keys");
  }
}, [TableDataAr]);
...
export default ProfitLossUpdateFormAr;
