...
useEffect(() => {
  autoResizeTextarea(textareaRef.current);
    ...
    // section One
    const [sectionOneFirstLabelEn, setSectionOneFirstLabelEn] = useState("Operating activities:" );
    const [sectionOneSecondLabelEn, setSectionOneSecondLabelEn] = useState("Income before Zakat" );
    ...
    // section Two
     const [sectionTwoFirstLabel, setSectionTwoFirstLabel] = useState("Adjustments for:");
   ...
   const [sectionThreeNotesEn, setFlowSectionThreeNotesEn] = useState<string[] >(Array(17).fill(""));
    ...
    // sectoin Four
     const [sectionFourFirstLabel, setSectionFourFirstLabel] = useState("Other changes");
...
// section Six
const [sectionSixFirstLabel, setSectionSixFirstLabel] = useState("Financing activities:");
...
const [sectionSixTotalLabel, setSectionSixTotalLabel] = useState("Net cash form (used in) financing activities");
...
const [sectionEightLastLabel, setSectionEightLastLabel] = useState("Significant non-cash transactions:");
...
const [sectionNineItemsDate2En, setSectionNineItemsDate2En] = useState<string[]>(Array(16).fill(""));
 ...
 <tr className="bg-gray-200 font-semibold">
            ...
            <tr className="bg-gray-100 font-semibold">
              ...
              <td className="border text-center border-gray-300 bg-gray-200 p-1"> <input
                  placeholder=""
            ...
            <tr className="bg-gray-200 font-semibold">
              ...
              <td className="border border-gray-300"> <input
                  ...
                  className="  p-0.5 text-center w-full bg-gray-200 fext-row"
                /></td>
              <td className="border border-gray-300">
 ...
 <tr className="bg-gray-200 font-semibold">
  ...
  return (
    <tr key={`section-seven-${idx}`} className="bg-gray-100">
      ...
      <td className="border border-gray-300">
        <input
          className="w-full bg-gray-100 text-center text-black p-1"
