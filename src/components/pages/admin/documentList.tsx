...
export const DocumentList: React.FC = () => {
  ...
  useEffect(() => {
    const fetchDocuments = async () => {
      ...
      try {
        ...
        const endpoint = adminLanguage === "English"? "/admin/getDocuments": "/admin/getArabicDocuments";
 ...
 // Parent Component: Assuming the parent component looks like this
        ...
        <div className="overflow-x-auto">
          ...
          <thead>
              <tr className="bg-gray-200 text-gray-700 text-xs sm:text-sm md:text-base">
                <th className="py-2 px-2 sm:px-4 border border-gray-300"> {language ==="Arabic" ?"الاسم الكامل":"Full Name"}</th>
                <th className="py-2 px-2 sm:px-4 border border-gray-300">{language ==="Arabic" ?" كنية":"NickName"}</th>
                <th className="py-2 px-2 sm:px-4 border border-gray-300">{language ==="Arabic" ?"كود تداول":"Tadawal Code"}</th>
                <th className="py-2 px-2 sm:px-4 border border-gray-300">{language ==="Arabic" ?" قطاع":"Sector"}</th>
               <th className="py-2 px-2 sm:px-4 border border-gray-300">{language ==="Arabic" ?"الإجراءات":"Actions"}</th>
              </tr>
     </thead>
