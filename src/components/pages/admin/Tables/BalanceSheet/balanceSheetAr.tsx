...
const BalaceSheetFormAr = React.memo(() => {
...
const dispatch=useDispatch<AppDispatch>()
 ...
 const [sassets, setAssets] = useState("الأصول");
  ...
  const [stotalliabilities, setTotalliabilities] = useState("إجمالي المطلوبات");
        ...
        <tbody className="">
          <tr className="bg-gray-300 font-semibold">
            ...
            <input
                ...
                onChange={(e) => setShareholdersEquityandliabilities(e.target.value)}
